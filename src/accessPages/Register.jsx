...
function Register() {
  ...
  return (
    <form
      className="w-11/12 md:max-w-md mx-auto bg-card formContainer my-8 md:my-16"
    ...
    >
      <div className="relative z-0 w-full mb-2 md:mb-5 group">
        <input
          ...
          name="floating_email"
          id="floating_email"
          className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer"
          placeholder=" "
          required
        />
        <label
          htmFor="floating_email"
      ...
      <div className="relative z-0 w-full mb-2 md:mb-5 group">
        ...
        <button
          ...
          className="absolute right-2 top-1/2  transform -translate-y-1 text-primary"
        >
          {eyeClose ? <LiaEyeSlashSolid /> : <LiaEyeSolid />}
        </button>

        <label
          htmFor="floating_password"
          className="peer-focus:font-medium absolute text-sm text-gray-500   duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >
          Password
        </label>
        {invalidInputPass && (
          <p className="text-sm text-red-500 font-thin">{invalidInputPass}</p>
        )}
      </div>
      ...
      <div className="relative z-0 w-full mb-2 md:mb-5 group">
        ...
        <label
          htmFor="floating_repeat_password"
          className="peer-focus:font-medium absolute text-sm text-gray-500   duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
        >
          Confirm password
        </label>
        {rePassErr && (
          <p className="text-sm font-thin text-red-500 inline-flex items-center ">
            {" "}
            <MdOutlineErrorOutline className="mr-2" /> {rePassErr}{" "}
          </p>
        )}
      </div>
      ...
      <div>
        <p className="font-light text-sm mt-2 text-primary">
          Already have an account?{" "}
          <Link
            to={"/login"}
            className="text-[#b8ab19] text-lg font-medium hover:underline"
          >
            Login
          </Link>
        </p>
