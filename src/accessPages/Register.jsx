...
import { updateProfile } from "firebase/auth";
 ...
 newUserWithEmailPass(Email, Pass)
 .then(result => {
...
<form className="w-11/12 md:max-w-md mx-auto bg-card formContainer my-8 md:my-16" onSubmit={handleSubmit}  >
  <div className="relative z-0 w-full mb-2 md:mb-5 group">
      <input type="email" name="floating_email" id="floating_email" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
  ...
  <div className="relative z-0 w-full mb-2 md:mb-5 group">
      <input type={`${eyeClose ? 'password' : 'text'}`} name="floating_password" id="floating_password"  className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
  ...
  <div className="relative z-0 w-full mb-2 md:mb-5 group">
      <input type="password" name="repeat_password" id="floating_repeat_password" onChange={repeatPassCheck} className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
  ...
  <div className="grid md:grid-cols-2 md:gap-6">
    <div className="relative z-0 w-full mb-2 md:mb-5 group">
        <input type="text" name="floating_first_name" id="floating_first_name" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
    ...
    <div className="relative z-0 w-full mb-2 md:mb-5 group">
        <input type="text" name="floating_last_name" id="floating_last_name" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
  ...
  <div className=" md:gap-6">
    <div className="relative z-0 w-full mb-2 md:mb-5 group">
        <input type="url"  name="floating_photoUrl" id="floating_phone" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
    ...
    {/* <div className="relative z-0 w-full mb-2 md:mb-5 group">
        <input type="text" name="floating_company" id="floating_company" className="block py-2.5 px-0 w-full text-sm bg-transparent border-0 border-b-2   appearance-none text-primary  border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-0   peer" placeholder=" " required />
